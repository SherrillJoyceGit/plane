    ...
    await createModule(workspaceSlug.toString(), selectedProjectId, payload)
      .then((_res) => {
        ...
        setToast({
          ...
          message: t("module.create.success"),
        });
      })
      .catch((err) => {
        setToast({
          ...
          message: err?.detail ?? err?.error ?? t("module.create.failed"),
        });
      });
  };
    ...
    await updateModuleDetails(workspaceSlug.toString(), selectedProjectId, data.id, payload)
      ...
      .catch((err) => {
        setToast({
          type: TOAST_TYPE.ERROR,
          title: t("common.error.label"),
          message: err?.detail ?? err?.error ?? t("entity.update.failed", { entity: t("common.module") }),
        });
      });
  };
