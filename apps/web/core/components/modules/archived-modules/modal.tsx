    ...
    await archiveModule(workspaceSlug, projectId, moduleId)
      .then(() => {
        setToast({
          ...
          title: t("module.archive.success_title"),
          message: t("module.archive.success_message"),
        });
        onClose();
      ...
      .catch(() =>
        setToast({
          ...
          message: t("module.archive.failed"),
        })
      )
    ...
    <ModalCore isOpen={isOpen} handleClose={onClose} position={EModalPosition.CENTER} width={EModalWidth.LG}>
      <div className="px-5 py-4">
        <h3 className="text-18 font-medium 2xl:text-20">
          {t("project_module.archive_module")} {moduleName}
        </h3>
        <p className="mt-3 text-13 text-secondary">{t("module.archive.confirm")}</p>
